...
This sidebar implementation has been superseded by the new navigation layout:
- New Sidebar: [`Sidebar.svelte`](src/components/layout/Sidebar.svelte)
...
Status:
- Retained temporarily for reference & potential diffing.
- Do NOT add new features here.
- Scheduled for removal after a11y checklist & functional verification complete (see [`nav-a11y-checklist.md`](nav-a11y-checklist.md)).

Migration Notes:
- Project list logic replaced by accessible list in ProjectList.
- Settings toggle replaced with explicit button using aria-pressed.
- Visual tokens pending theming pass.

Remove after tasks #15 & #16 are completed in rewrite todo list.
-->
<script>
